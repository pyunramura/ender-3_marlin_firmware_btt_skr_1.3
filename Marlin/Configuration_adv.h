...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    77  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
 ...
 */
  ...
  #define INTERPOLATE       true  // Interpolate X/Y/Z_MICROSTEPS to 256
    ...
    #define X_CURRENT     540  // (mA) RMS current. Multiply by 1.414 for peak current.
                               // E3 RMS is actually max current; see "E3_Motor_Current.txt" in "Ender 3 Parts and Files" on NAS.
  ...
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT     540 // E3 RMS is actually max current; see "E3_Motor_Current.txt" in "Ender 3 Parts and Files" on NAS.
    #define Y_MICROSTEPS   16
  ...
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT     540 // E3 RMS is actually max current; see "E3_Motor_Current.txt" in "Ender 3 Parts and Files" on NAS.
    #define Z_MICROSTEPS   16
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT    636 // Calulated RMS for Steppersonline 20 mm stepper. MaxCurrent*0.707=RMS. 90% safe value RMS*0.9=SafeRMS.
   ...
   */
  #define SQUARE_WAVE_STEPPING // must be enabled currently to use linear advance even with stealthchop disabled
