...
#define STRING_CONFIG_H_AUTHOR "(pyunramura, Ender-3)" // Who made the changes.
...
#define MACHINE_UUID "a7b2fe26-56dd-4565-ac16-3d97da122437"
...
#define EXTRUDE_MAXLENGTH (X_BED_SIZE * 2)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 416.937 }
 ...
 */
//#define S_CURVE_ACCELERATION // Does not work well with linear advance right now; causes overextrusion on sharp corners.
...
#define X_BED_SIZE (233 - 3) // 233 since nozzle runs off of bed at 233, -3 for ~2 mm inset from left edge
#define Y_BED_SIZE (235 - 4) // -4 since nozzle hits bed strain relief
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEFT_PROBE_BED_POSITION (MIN_PROBE_EDGE + abs(X_PROBE_OFFSET_FROM_EXTRUDER))
  #define RIGHT_PROBE_BED_POSITION (X_BED_SIZE - abs(X_PROBE_OFFSET_FROM_EXTRUDER) - (MIN_PROBE_EDGE))
  #define FRONT_PROBE_BED_POSITION (14 + abs(Y_PROBE_OFFSET_FROM_EXTRUDER) + (MIN_PROBE_EDGE))
  #define BACK_PROBE_BED_POSITION (Y_BED_SIZE - abs(Y_PROBE_OFFSET_FROM_EXTRUDER) - (MIN_PROBE_EDGE))
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_HEIGHT 0.127 // (mm) Z height of nozzle at leveling points
 ...
 */
#define Z_PROBE_END_SCRIPT "G1 Z10 F5700\nG1 X1 Y-13"
